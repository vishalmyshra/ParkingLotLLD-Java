	...
	public static void main(String[] args) {
		try {
			...
			try {
				...
				System.out
						.println("Car parked with ticket: " + (carTicket != null ? carTicket.getTicketId() : "Failed"));
			} catch (Exception e) {
			...
			try {
				...
				System.out.println(
						"Bike parked with ticket: " + (bikeTicket != null ? bikeTicket.getTicketId() : "Failed"));
			} catch (Exception e) {
			...
			try {
				...
				System.out.println(
						"Truck parked with ticket: " + (truckTicket != null ? truckTicket.getTicketId() : "Failed"));
			} catch (Exception e) {
